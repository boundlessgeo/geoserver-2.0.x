...
//    }
    ...
    public void testWCS11DescribeCoverage() throws Exception {
        net.opengis.wcs11.DescribeCoverageType dc = Wcs111Factory.eINSTANCE.createDescribeCoverageType();
    ...
    public void testWCS11GetCoverage() throws Exception {
        net.opengis.wcs11.GetCoverageType gc = Wcs111Factory.eINSTANCE.createGetCoverageType();
