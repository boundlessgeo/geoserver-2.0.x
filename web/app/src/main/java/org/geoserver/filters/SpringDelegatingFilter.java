 ...
 * 
 * <p>
 * A composite servlet filter that loaders {@link Filter} instances from a spring context, 
 * rather then from the traditional web.xml. This class allows for servlet filters to be dynamically 
 * contributed via a spring context. 
 * </p>
 *
 */
